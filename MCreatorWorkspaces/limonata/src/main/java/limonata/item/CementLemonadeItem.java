...
import limonata.procedures.CementLemonadeEffectProcedure;
...
public class CementLemonadeItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.limonata.cement_lemonade.description_0"));
		list.add(Component.translatable("item.limonata.cement_lemonade.description_1"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		CementLemonadeEffectProcedure.execute(entity);
