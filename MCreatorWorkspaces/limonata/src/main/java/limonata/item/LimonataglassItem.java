...
import limonata.procedures.LimonataglassPlayerFinishesUsingItemProcedure;
...
public class LimonataglassItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.limonata.glass_of_lemonade.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		LimonataglassPlayerFinishesUsingItemProcedure.execute(entity);
