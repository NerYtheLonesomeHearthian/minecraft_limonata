...
import limonata.procedures.BricksLemonadeEffectProcedure;

import limonata.init.LimonataModItems;

import java.util.List;

public class BricksLemonadeItem extends Item {
	public BricksLemonadeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.limonata.bricks_lemonade.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		BricksLemonadeEffectProcedure.execute(entity);
