...
import limonata.procedures.PowderLemonadeEffectProcedure;
...
public class PowderLemonadeItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.limonata.powder_lemonade.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		PowderLemonadeEffectProcedure.execute(entity);
