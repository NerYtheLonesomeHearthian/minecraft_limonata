...
@Mod("limonata")
public class LimonataMod {
	public static final Logger LOGGER = LogManager.getLogger(LimonataMod.class);
	public static final String MODID = "limonata";

	public LimonataMod(IEventBus modEventBus) {
